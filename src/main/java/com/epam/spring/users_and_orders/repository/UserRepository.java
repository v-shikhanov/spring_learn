...
public class UserRepository {
    ...
    private static final List<String> USERS_NAMES = List.of("Ivan", "Andrey", "Maxim", "Iluya", "Alexey", "John", "Petr",
            "Semeon", "Artem", "Vladimir", "Donald");
    private static final List<String> USERS_LAST_NAMES = List.of("Ivanov", "Andreev", "Maximov", "Iluyich", "Alexeev",
            "Smith", "Petrov", "Semenov", "Artemov", "Putin", "Trump");
    private static final List<String> ORDERS_NAMES = List.of("Potato", "Tomato", "Cucumber", "Coffee", "Tea",
